...
function parseDescriptorFields(raw: Uint8Array): DescriptorField[] {
    const type = raw[1];
    switch (type) {
        case 0x01: return parseDeviceDescriptor(raw);
        case 0x02: return parseConfigurationDescriptor(raw);
        case 0x03: return parseStringDescriptor(raw);
        case 0x04: return parseInterfaceDescriptor(raw);
        case 0x05: return parseEndpointDescriptor(raw);
        case 0x0b: return parseInterfaceAssociationDescriptor(raw);
        case 0x21: return parseHidDescriptor(raw);
        case 0x24: return parseHubDescriptor(raw);
        default: return parseGenericDescriptor(raw);
    }
}
